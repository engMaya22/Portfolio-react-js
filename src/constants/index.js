...
export const PROJECTS = [
  ...
  {
    link: "https://glowpas.com/en",
    title: "Glowpas platform",
    image: glowpas,
    description:
      "Built a multi-tenant assessment platform that turns one survey into four branded PDF report products for individuals, leaders, teams, and organizations. Owned the reporting layer: custom polar and comparison charts, and a queued Puppeteer-to-mPDF engine producing 100+ page bilingual (EN/AR, RTL) documents.",
    technologies: [
      "Laravel",
      "Filament",
      "Livewire",
